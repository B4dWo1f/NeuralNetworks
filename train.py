...
def usage():
   ...
   msg += ' (it is important to have spaces in this argument)\n'
   msg += '  -o: Specify the file in which to store the neural network '
   msg += '[default: my_network.xml]\n'
   msg += '\nexample:\n'
   msg += 'If we have a training data file where each example has 2 inputs and'
   msg += ' 3 outputs and we want an architecture (2,5,8,3) we would run\n'
   msg += '$ ./train.py -i datos.train -n 1 -ar 2 5 8 5 3\n\n'
